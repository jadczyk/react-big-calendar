...
var _MonthDayCellsRow = require('./MonthDayCellsRow');

var _MonthDayCellsRow2 = _interopRequireDefault(_MonthDayCellsRow);
...
var DateContentRow = function (_React$Component) {
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['date', 'rtl', 'events', 'range', 'className', 'selectable', 'dayPropGetter', 'renderForMeasure', 'startAccessor', 'endAccessor', 'renderHeader', 'minRows', 'maxRows', 'dateCellWrapper', 'eventComponent', 'eventWrapperComponent', 'onSelectStart', 'onSelectEnd', 'longPressThreshold']);
    ...
    while (levels.length < minRows) {
      ...
      _react2.default.createElement(_MonthDayCellsRow2.default, _extends({}, props, {
        events: events,
        range: range,
