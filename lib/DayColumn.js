...
var DayColumn = function (_React$Component) {
  ...
  DayColumn.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['min', 'max', 'step', 'now', 'selectRangeFormat', 'culture', 'dayPropGetter']);
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot', className, _dates2.default.isToday(max) && 'rbc-today'),
        style: style,
        now: now,
        min: min,
        max: max,
