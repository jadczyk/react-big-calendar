...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    var eventsRendered = this.renderEvents(range, rangeEvents, this.props.now, resources || [null]);
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      return _react2.default.createElement(
        ...
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', className, _dates2.default.isToday(date) && 'rbc-today'),
          style: _extends({}, dayStyles, (0, _eventLevels.segStyle)(1, _this6.slots))
        },
