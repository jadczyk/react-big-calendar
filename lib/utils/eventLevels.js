...
function eventDaySegment(event, date, _ref4) {
  ...
  //start within day
  if (_dates2.default.gte(eStart, dayStart) && _dates2.default.lt(eStart, dayEnd)) {
    var segmentEnd = _dates2.default.min(eEnd, dayEnd);
    var segmentStart = eStart;
    var continuesAfter = false;
    if (_dates2.default.gt(eEnd, dayEnd)) {
      //ends another day
      continuesAfter = true;
    }
    return {
  ...
  } else if (_dates2.default.gt(eEnd, dayStart) && _dates2.default.lte(eEnd, dayEnd)) {
  ...
  } else if (_dates2.default.gt(eEnd, dayStart) && _dates2.default.lt(eStart, dayStart)) {
    //multiday event
    var _segmentStart2 = dayStart;
    var _segmentEnd2 = dayEnd;
    return {
      event: event,
      segmentStart: _segmentStart2,
      segmentEnd: _segmentEnd2,
